import { Circle, Sparkles, Target } from "lucide-react";
...
export default function NotificationCard({ item, onMarkAsRead }: NotificationCardProps) {
  return (
    <article
      className={[
    ...
    >
      ...
      <Button
        ...
        disabled={item.read}
        className="self-start md:self-center normal-case tracking-normal text-base px-4 py-2 border-b-2 rounded-lg"
      >
